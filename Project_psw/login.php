...
$username = $koneksi->real_escape_string($inputData['username']);
$password = $koneksi->real_escape_string($inputData['password']);
$role     = $koneksi->real_escape_string($inputData['role']);
